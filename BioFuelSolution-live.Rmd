...
set.bounds(model, lower = rep(0,16))

set.objfn(model, c(2,2,
                   2.5,
                   2,
                   1,1,
                   1.5,
...
add.constraint(model, c(1,1,-3,-3),"<=", 0, c(1,2,8,9))
add.constraint(model, c(1,-3,-3),"<=", 0, c(3,10,11))
add.constraint(model, c(1,-3,-3),"<=", 0, c(4,12,13))
add.constraint(model, c(1,1,-3,-3),"<=", 0, c(5,6,14,15))
add.constraint(model, c(1,-3),"<=", 0, c(7,16))

# Q1 constraints
add.constraint(model, 1,">=", 420, 1)
add.constraint(model, 1,">=", 780, 8)

# Q2 constraints
add.constraint(model, rep(1,2),">=", 385, c(2,3))
add.constraint(model, rep(1,2),">=", 715, c(9,10))

# Q3 constraints
add.constraint(model, rep(1,2),">=", 455, c(4,5))
add.constraint(model, rep(1,3),">=", 845, c(11,12,13))

# Q4 constraints
add.constraint(model, rep(1,2),">=", 350, c(6,7))
add.constraint(model, rep(1,3),">=", 650, c(14,15,16))
